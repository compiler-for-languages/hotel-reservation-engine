...
export default function CheckOutPage() {
  ...
  const mutation = useMutation({
    mutationFn: (payload: FormValues) => ReceptionService.checkOut({ reservationId: Number(payload.reservationId) }),
    onError: (error) => {
      toast.error(getApiErrorMessage(error, "Failed to check out guest."));
    },
  });
  ...
  return (
    <div className="space-y-5">
      ...
      <ConfirmDialog
        ...
        description="Proceed with check-out for this reservation?"
